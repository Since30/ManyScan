...
export default function TopAnimeCard() {
    return (
        <div className="h-full p-5">
            <span className="font-bold font-xl text-black">Top 5 mangas</span>
            <div className="overflow-x-scroll overflow-y-hidden w-full min-h-full max-h-full  h-full border shadow rounded-sm bg-white p-5 flex space-x-4">
