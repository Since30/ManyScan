...
export default function TopAnimeCard(props: Props) {
    return (
        <div className="h-full p-5">
            ...
            <div className="overflow-x-scroll overflow-y-hidden w-full min-h-full max-h-full  h-full border shadow rounded-sm dark:bg-black bg-white dark:border-black p-5 flex space-x-4 items-center">
                <img src={ `${props.anime.img}` } className="rounded-sm"/>
                <div>
                    <span className="font-bold font-2xl dark:text-white text-black opacity-90">{ props.anime.title }</span>
                    <p className="dark:text-white text-black opacity-70">
                    {
